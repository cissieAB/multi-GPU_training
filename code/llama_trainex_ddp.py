                ...
                for batch in train_dataloader:
                    ...
                    for i in range(num_iters):
                        if 40<i<=50:
                            ...
                            eg.register_callback("./llama_profiler/graph_"+name.replace("/","-")+"-"+hostname+"-rank"+str(rank)+"-iter"+str(i)+".json")
                            eg.start()
                            ...
                            prof.export_chrome_trace("./llama_profiler/profiler_"+name.replace("/","-")+"-"+hostname+"-rank"+str(rank)+"-iter"+str(i)+".json")
                            eg.stop()
